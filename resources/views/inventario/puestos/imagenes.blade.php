...
@section('title', 'Inv-Puesto/Imágenes')
...
@section('content')
    <div class="card">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="image-wrapper">
                                    <img class="img-fluid rounded-sm" id="picture" src="{{Storage::url($imagen->url)}}" alt="Imagen de Puesto">
                                </div>
                            </div>
        ...
        @else
            <div class="card-body">
                <h5>No hay imágenes del Puesto</h5>
            </div>
        @endif
