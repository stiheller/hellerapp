    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col">
                    <form action="{{route('inventario.imagenImpresoras.store', $impresora)}}" method="POST" enctype="multipart/form-data">
                        @csrf
