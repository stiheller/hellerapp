@extends('adminlte::page')
    ...
    @section('content_header')
        @can('administracion.rubro.create')
            <a class="btn btn-secondary btn-sm float-right" href="{{ route('administracion.rubro.create') }}"><i class="fas fa-plus-square fa-fw"></i> Nuevo Rubro</a>
        @endcan
                                        ...
                                        <div class="btn-group">
                                            <button type="button" class="btn btn-info dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"></button>
                                                <div class="dropdown-menu">
                                                        @can('administracion.rubro.edit')
                                                            <a class="dropdown-item" href="{{ route('administracion.rubro.edit', $item->id) }}"><i class="fas fa-edit"></i> Editar </a>
                                                            <div class="dropdown-divider"></div>
                                                        @endcan
                                                        @can('administracion.rubro.destroy')
                                                            <form action="{{ route('administracion.rubro.destroy', $item->id) }}" method="POST" style="display: inline-block;"
                                                                onsubmit="return confirm('Esta seguro de Eliminar el Rubro')">
                                                                @csrf
                                                                @method('DELETE')
